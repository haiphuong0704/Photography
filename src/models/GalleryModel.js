...
class GalleryModel {
  static getAll() {
    return [
      // Wedding
      { id:  1, category: 'wedding', label: 'Cưới',        caption: 'Linh & Khoa — Lễ rước dâu',  num: '101', photo: U('1520854221256-17451cc331bf',400,500), ar: '4/5'  },
      { id:  5, category: 'wedding', label: 'Pre-wedding', caption: 'Thảo & Nam — Đà Lạt',         num: '105', photo: U('1573676048035-9c2a72b6a12a',400,400), ar: '1/1'  },
      ...
      // Product
      { id: 15, category: 'product',  label: 'F&B',         caption: 'Menu Nhà hàng Vy',            num: '115', photo: U('1633614386903-27d7eb3e8b20',400,400), ar: '1/1'  },
      { id: 16, category: 'product',  label: 'Skincare',    caption: 'Bộ sản phẩm dưỡng da',        num: '116', photo: U('1627117204847-ec306fe712bb',400,500), ar: '4/5'  },
